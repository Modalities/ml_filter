...
class AnnotatorModel(nn.Module):
    ...
    def _overwrite_head(self):
        ...
        if hasattr(self.base_model, "classifier"):
            if hasattr(self.base_model.classifier, "out_proj"):
                self.base_model.classifier.out_proj = self.head
            else:
    ...
    def forward(self, **kwargs):
        ...
        # We are using **kwargs here because
        # it ensures independence to signature changes in the base model's forward method.
